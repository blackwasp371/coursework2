...
cur = con.cursor()
cur.execute("create table if not exists hosteld(t_r number,r_r number,t_s number)")
...
def mainroot():
	...
	def hostel_status():
		...
		label.image=img
		label.place(x=0,y=0)
		cur.execute("select * from hosteld")
		x = cur.fetchall()
		#print(x)
	...
	#------------inner frames of bottom frame-------------------------
		...
		ts = Label(smf5,text='Total Staffs:',fg='white',bg='cyan4',width=130,height=2,font='helvetica 15')
		ts.pack(side='top')
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Aakash Hostel',fg='blue',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Warden",bg='white',font='msserif 17 bold').place(x=60,y=0)
		Label(emp1inf,text="Mr. Aakash Pun Magar",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : aakashpunmagar@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		...
		Label(emp1inf,text="Ms. Ting TOng",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Extention : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : ting124@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Canteen",bg='white',font='msserif 17 bold').place(x=72,y=0)#pack(side='top')
		Label(emp1inf,text="Mr. Ajay Singh",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Extention : 02",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : ajaysingh@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Helper",bg='white',font='msserif 17 bold').place(x=55,y=0)#pack(side='top')
		Label(emp1inf,text="Ms. Priyanka Magar",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		Label(emp1inf,text="Extention : 03",bg='white',fg="Grey",font='msserif 10').place(x=55,y=59)
		Label(emp1inf,text="Mail : Priyanka121@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)
		emp1inf.pack_propagate(False)
	...
	b2 = Button(sl_frame,image=img1,text='b2',bg='white',width=180,command=hostel_status)
	b2.image = img1
	b2.place(x=0,y=0)
	...
	#-------------------------------------------------------------------------------------------------------------------------------------------------
	#hostel_status() # calling the bottom frame for default page
	#login()
	#rooms()
	#payments()
